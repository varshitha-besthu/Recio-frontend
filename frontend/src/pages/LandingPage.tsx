...
export default function LandingPage(){
    return (
        <div className="overflow-x-hidden">
            ...
            <div className="h-screen flex items-center justify-center max-w-screen mx-auto ">
            ...
            {/* pricing section */}
            <div className="h-screen  mt-8 max-w-screen">
            ...
            <div className="w-full relative overflow-x-hidden py-8">
